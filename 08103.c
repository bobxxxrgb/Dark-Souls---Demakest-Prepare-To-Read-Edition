...
save();    
  ...
  cin >> chose;
     ...
     case 'W':
     if(asyldemfight==1){
     Asylum_Demon();if(undasyl==10){asyldemdoor=1;asyldemfight=0;world=0;undasyl=4;humanity++;
     cout<<endl<<endl<<"The Asylum Demon dropped a Humanity!"<<endl<<endl;}}
     else{hp=hp-maxhp/5;world=0;undasyl=4;asyldemdoor=1;}
     break;
     case'e':
     case'E':
     menu();
