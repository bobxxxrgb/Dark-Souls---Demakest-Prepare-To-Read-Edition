...
using namespace std;
  ...
  int x;       int newgame; int world; int undasyl;  int bow;  int item1;int door1;int soul1;int humanity;string shop1;
  int asyldemdoor; int asyldemfight;   int firelink;           int item2;int door2;int soul2;int regen;string shop2;
  int undburg; int catacombs;int petitelondo;    int maxstm;   int item3;int door3;int soul3;string shop3;
  int lastbonf;int hostile; char oppatt;int fight;int maxestus;int item4;int door4;int soul4;string shop4;
  int run;     int estus;   int hp;    int maxhp;int stm;      int item5;int door5;int bomb;int shopper;
  ...
  string savex;string opponent;string weapon;string name;string petrus;string crestf;string griggs; string logan;
  string reah; string vince; string nico; string laurentius; string ingward; string anastacia; string frampt;string patches;string lautrec;
  int crst;int petr;int mage;int wise;int pray;int knht1;int knht2;int pyr;int strg;int firek;int srp1;int strnz;int lautrecz;
...
//-----------------------------------------------load-ground-items-------------------------------------
    ...
    if(sv_48.is_open())
    {sv_48<<to_string(firelink*95610);}sv_48.close();
...
"(1)"<<endl<<crestf<<endl<<
"(2)"<<endl<<petrus<<endl<<
"(3)"<<endl<<anastacia<<endl<<
"(4)"<<endl<<griggs<<endl<<
"(5)"<<endl<<logan<<endl<<
"(6)"<<endl<<reah<<endl<<
"(7)"<<endl<<vince<<endl<<
"(8)"<<endl<<nico<<endl<<
"(9)"<<endl<<laurentius<<endl<<
"(0) Others"<<endl<<endl<<"input: ";
cin >> chose;
switch(chose){
case'1':
...
int main() {
petrus="Petrus";crestf="Crestfallen Warrior";anastacia="Fire keeper";griggs="---";logan="---";laurentius="---";
reah="---";vince="---";nico="---";ingward="---";frampt="---";patches="---";lautrec="---";
...
cout << "'Undead Asylum'  'Snowy Precipice'"<<endl<<"Souls: "<<souls<<endl<<hp<<"HP    "<<stm<<"STM"
  ...
  cin >> chose;
     ...
     cout<<" Lordran.";wait();system("clear");gotolord=1;
     }
     ...
     cout<<"Several hours later it finally lands"<<endl<<"and drops you right in front of a Bonfire.";wait();system("clear");
  ...
  <<endl<<endl<<"Select where to go:"<<endl<<
   "(W) Up the stairs on the precipice"<<endl<<"(A) Down the stairs in front of a burnt tree"<<endl<<"(S) Up the stairs over the chapel"<<endl<<"(D) Over the monument to the graveyard"<<endl<<"(Q) Bonfire"<<endl<<"(E) Inventory"<<endl<<"(B) Talk"
  <<endl<<endl<<"input: ";
  cin >> chose;
     switch(chose) {
     case 'w':
