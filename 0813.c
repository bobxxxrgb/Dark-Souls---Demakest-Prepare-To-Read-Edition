...
using namespace std;
  ...
  string reah; string vince; string nico; string laurentius; string ingward; string anastacia; string frampt;string patches;
  int crst;int petr;int mage;int wise;int pray;int knht1;int knht2;int pyr;int strg;int firek;int srp1;int strnz;
...
reah="---";vince="---";nico="---";ingward="---";frampt="---";patches="---";
...
x=9;//let's fucking go, go, go, go...
    ...
    lastbonf=0;  item2=1;door2=0;soul2=0;regen=0;
      world= 1;  item3=1;door3=0;soul3=0;
    undasyl= 0;  item4=1;door4=0;soul4=0;
asyldemdoor= 1;  item5=1;door5=0;bomb=0;
asyldemfight=1;  item6=1;door6=0;darkbomb=0;
       oscar=0;  item7=1;door7=0;herb=0;
   firelink= 1;  item8=1;door8=0;bless=0;
    gotolord=1; snuggly=0;
    undburg= 0;
  catacombs= 0;
petitelondo= 0;
     oppatt= 0;
