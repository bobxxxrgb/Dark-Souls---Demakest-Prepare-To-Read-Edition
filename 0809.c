#include <iostream>  //first estus and inventory implementation
#include <fstream>
#include <string>
#include <chrono>
#include <thread>
...
using namespace std;
  ...
  int oppsouls;char chose;  char input;
...
void bonfire(){
     hp=maxhp;
      if(oscar==0){
      cout<<endl<<endl<<"Health restored and Estus replenished."<<endl<<endl;estus=5;}
...
int main() {
x=9;
    newgame= 0;  item1=1;door1=0;soul1=1;humanity=3;
    lastbonf=0;  item2=1;door2=0;soul2=0;regen=0;
      world= 0;  item3=1;door3=0;soul3=0;
    undasyl= 0;  item4=1;door4=0;soul4=0;
asyldemdoor= 1;  item5=1;door5=0;bomb=69;
asyldemfight=1;  item6=1;door6=0;darkbomb=69;
       oscar=1;  item7=1;door7=0;herb=79;
   firelink= 0;  item8=1;door8=0;bless=9;
    undburg= 0;
  catacombs= 0;
petitelondo= 0;
     oppatt= 0;
...
if (undasyl==0) {                          //cell
  ...
  "(B) Check cell on the left"<<endl<<"(C) Check corpse in the middle of the stairs"<<endl<<"(D) Into Balcony"<<endl<<endl<<"input: ";
  cin >> chose;
     switch(chose) {
     case 'a':
     case 'A':
     ...
     case 'B':
      if(item2==1){
      cout<<endl<<endl<<"You found a Green Blossom on a corpse in the cell."<<endl<<endl;herb=herb+1;item2=0;}
