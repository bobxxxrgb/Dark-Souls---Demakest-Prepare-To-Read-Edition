...
using namespace std;
  ...
  int atk;         int def;         int frdef;      int oppatk;   int oppdef;   int item7;   int door7;   int herb;    string segue;
  ...
  void save(){
system("mkdir -p /usr/games/Dark_Souls-Demakest");                   //game folder                 #0
system("mkdir -p /usr/games/Dark_Souls-Demakest/dir_1");            //stats dir                   #1
system("mkdir -p /usr/games/Dark_Souls-Demakest/dir_2");           //mircroarea/macroarea dir    #2
system("mkdir -p /usr/games/Dark_Souls-Demakest/dir_3");          //npc dir                     #3
system("mkdir -p /usr/games/Dark_Souls-Demakest/dir_4");         //locked doors dir            #4
system("mkdir -p /usr/games/Dark_Souls-Demakest/dir_5");        //ground items dir            #5
system("mkdir -p /usr/games/Dark_Souls-Demakest/dir_6");       //boss events dir             #6
...
//------------------------------------------------save-microarea---------------------------------------
  ...
  const char *path7="/usr/games/Dark_Souls-Demakest/dir_2/sv_7";
    ofstream sv_7(path7);
    string data7(to_string(world*95610));                       //world
    sv_7<< data7;

if(world==0){
 const char *path8="/usr/games/Dark_Souls-Demakest/dir_2/sv_8";
    ofstream sv_8(path8);
    string data8(to_string(undasyl*95610));                    //undasyl
    sv_8<< data8;
}
if(world==1){
 const char *path8="/usr/games/Dark_Souls-Demakest/dir_2/sv_8";
    ofstream sv_8(path8);
    string data8(to_string(firelink*95610));                   //firelink
    sv_8<< data8;
}

//------------------------------------------------save-microarea---------------------------------------

 const char *path9="/usr/games/Dark_Souls-Demakest/dir_1/sv_9";
    ofstream sv_9(path9);
    string data9(to_string(soul1*95610));                         //soul1
    sv_9<< data9;

 const char *path10="/usr/games/Dark_Souls-Demakest/dir_1/sv_10";
    ofstream sv_10(path10);
    string data10(to_string(soul2*95610));                       //soul2
    sv_10<< data10;
    
 const char *path11="/usr/games/Dark_Souls-Demakest/dir_1/sv_11";
    ofstream sv_11(path11);
    string data11(to_string(soul3*95610));                      //soul3 
    sv_11<< data11;
    
 const char *path12="/usr/games/Dark_Souls-Demakest/dir_1/sv_12";
    ofstream sv_12(path12);
    string data12(to_string(soul4*95610));                      //soul4
    sv_12<< data12;
    
 const char *path13="/usr/games/Dark_Souls-Demakest/dir_1/sv_13";
    ofstream sv_13(path13);
    string data13(to_string(bomb*95610));                        //bomb
    sv_13<< data13;
    
  const char *path14="/usr/games/Dark_Souls-Demakest/dir_1/sv_14";
    ofstream sv_14(path14);
    string data14(to_string(darkbomb*95610));                     //darkbomb
    sv_14<< data14;
    
 const char *path15="/usr/games/Dark_Souls-Demakest/dir_1/sv_15";
    ofstream sv_15(path15);
    string data15(to_string(herb*95610));                         //herb
    sv_15<< data15; 
    
 const char *path16="/usr/games/Dark_Souls-Demakest/dir_1/sv_16";
    ofstream sv_16(path16);
    string data16(to_string(bless*95610));                       //bless
    sv_16<< data16;
    
 const char *path17="/usr/games/Dark_Souls-Demakest/dir_1/sv_17";
    ofstream sv_17(path17);
    string data17(to_string(humanity*95610));                    //humanity
    sv_17<< data17;

 const char *path19="/usr/games/Dark_Souls-Demakest/dir_1/sv_19";
    ofstream sv_19(path19);
    string data19(to_string(estus*95610));                       //estus
    sv_19<< data19;
    

 const char *path20="/usr/games/Dark_Souls-Demakest/dir_1/sv_20";
    ofstream sv_20(path20);
    string data20(to_string(maxestus*95610));                   //maxestus
    sv_20<< data20;

 const char *path21="/usr/games/Dark_Souls-Demakest/dir_1/sv_21";
    ofstream sv_21(path21);
    string data21(to_string(lastbonf*95610));                   //lastbonf
    sv_21<< data21;

//-----------------------------------------------load-one-side-doors-----------------------------------
 const char *path22="/usr/games/Dark_Souls-Demakest/dir_4/sv_22";
    ofstream sv_22(path22);
    string data22(to_string(door1*95610));                       //door1
    sv_22<< data22;

 const char *path23="/usr/games/Dark_Souls-Demakest/dir_4/sv_23";
    ofstream sv_23(path23);
    string data23(to_string(door2*95610));                       //door2
    sv_23<< data23;

 const char *path25="/usr/games/Dark_Souls-Demakest/dir_4/sv_25";
    ofstream sv_25(path25);
    string data25(to_string(door3*95610));                       //door3
    sv_25<< data25;

 const char *path26="/usr/games/Dark_Souls-Demakest/dir_4/sv_26";
    ofstream sv_26(path26);
    string data26(to_string(door4*95610));                       //door4
    sv_26<< data26;

 const char *path27="/usr/games/Dark_Souls-Demakest/dir_4/sv_27";
    ofstream sv_27(path27);
    string data27(to_string(door5*95610));                       //door5
    sv_27<< data27;

 const char *path28="/usr/games/Dark_Souls-Demakest/dir_4/sv_28";
    ofstream sv_28(path28);
    string data28(to_string(door6*95610));                       //door6
    sv_28<< data28;

 const char *path29="/usr/games/Dark_Souls-Demakest/dir_4/sv_29";
    ofstream sv_29(path29);
    string data29(to_string(door7*95610));                      //door7
    sv_29<< data29;

 const char *path30="/usr/games/Dark_Souls-Demakest/dir_4/sv_30";
    ofstream sv_30(path30);
    string data30(to_string(door8*95610));                      //door8
    sv_30<< data30;
...
//-----------------------------------------------load-ground-items-------------------------------------
 ...
 const char *path31="/usr/games/Dark_Souls-Demakest/dir_5/sv_31";
    ofstream sv_31(path31);
    string data31(to_string(item1*95610));                       //item1
    sv_31<< data31;

 const char *path32="/usr/games/Dark_Souls-Demakest/dir_5/sv_32";
    ofstream sv_32(path32);
    string data32(to_string(item2*95610));                       //item2
    sv_32<< data32;

 const char *path33="/usr/games/Dark_Souls-Demakest/dir_5/sv_33";
    ofstream sv_33(path33);
    string data33(to_string(item3*95610));                       //item3
    sv_33<< data33;

 const char *path34="/usr/games/Dark_Souls-Demakest/dir_5/sv_34";
    ofstream sv_34(path34);
    string data34(to_string(item4*95610));                       //item4
    sv_34<< data34;

 const char *path36="/usr/games/Dark_Souls-Demakest/dir_5/sv_36";
    ofstream sv_36(path36);
    string data36(to_string(item5*95610));                       //item5
    sv_36<< data36;

 const char *path37="/usr/games/Dark_Souls-Demakest/dir_5/sv_37";
    ofstream sv_37(path37);
    string data37(to_string(item6*95610));                       //item6
    sv_37<< data37;

 const char *path38="/usr/games/Dark_Souls-Demakest/dir_5/sv_38";
    ofstream sv_38(path38);
    string data38(to_string(item7*95610));                       //item7
    sv_38<< data38;

 const char *path39="/usr/games/Dark_Souls-Demakest/dir_5/sv_39";
    ofstream sv_39(path39);
    string data39(to_string(item8*95610));                       //item8
    sv_39<< data39;

 const char *path48="/usr/games/Dark_Souls-Demakest/dir_5/sv_48";
    ofstream sv_48(path48);
    string data48(to_string(item9*95610));                      //item9
    sv_48<< data48;

//-----------------------------------------------load-ground-items-------------------------------------
 const char *path40="/usr/games/Dark_Souls-Demakest/dir_1/sv_40";
    ofstream sv_40(path40);
    string data40(to_string(newgame*95610));                     //newgame
    sv_40<< data40;    


 const char *path43="/usr/games/Dark_Souls-Demakest/dir_1/sv_43";
    ofstream sv_43(path43);
    string data43(name);                                         //name
    sv_43<< data43;  
    

 const char *path44="/usr/games/Dark_Souls-Demakest/dir_1/sv_44";
    ofstream sv_44(path44);
    string data44(to_string(atk*95610));                        //atk
    sv_44<< data44;  

 const char *path45="/usr/games/Dark_Souls-Demakest/dir_1/sv_45";
    ofstream sv_45(path45);
    string data45(to_string(def*95610));                        //def
    sv_45<< data45;  

 const char *path46="/usr/games/Dark_Souls-Demakest/dir_1/sv_46";
    ofstream sv_46(path46);
    string data46(to_string(frdef*95610));                      //frdef
    sv_46<< data46;  

 const char *path47="/usr/games/Dark_Souls-Demakest/dir_1/sv_47";
    ofstream sv_47(path47);
    string data47(to_string(regen*95610));                       //regen
    sv_47<< data47;  


const char *path41="/usr/games/Dark_Souls-Demakest/dir_6/sv_41";
    ofstream sv_41(path41);
    string data41(to_string(asyldemfight*95610));               //asyldemfight
    sv_41<< data41;  


const char *path42="/usr/games/Dark_Souls-Demakest/dir_6/sv_42";
    ofstream sv_42(path42);
    string data42(to_string(asyldemdoor*95610));               //asyldemdoor
    sv_42<< data42;  

//-------------------------------------------save-npc-----------------------------------------------
 const char *path18="/usr/games/Dark_Souls-Demakest/dir_3/sv_18";
    ofstream sv_18(path18);
    string data18(to_string(oscar*95610));                       //oscar
    sv_18<< data18;

 const char *path49="/usr/games/Dark_Souls-Demakest/dir_3/sv_49";
    ofstream sv_49(path49);
    string data49(to_string(crst*95610));                        //crst
    sv_49<< data49;

 const char *path50="/usr/games/Dark_Souls-Demakest/dir_3/sv_50";
    ofstream sv_50(path50);
    string data50(to_string(petr*95610));                       //petr
    sv_50<< data50;

 const char *path51="/usr/games/Dark_Souls-Demakest/dir_3/sv_51";
    ofstream sv_51(path51);
    string data51(to_string(mage*95610));                       //mage
    sv_51<< data51;

 const char *path52="/usr/games/Dark_Souls-Demakest/dir_3/sv_52";
    ofstream sv_52(path52);
    string data52(to_string(wise*95610));                       //wise
    sv_52<< data52;

 const char *path53="/usr/games/Dark_Souls-Demakest/dir_3/sv_53";
    ofstream sv_53(path53);
    string data53(to_string(pray*95610));                       //pray
    sv_53<< data53;

 const char *path54="/usr/games/Dark_Souls-Demakest/dir_3/sv_54";
    ofstream sv_54(path54);
    string data54(to_string(knht1*95610));                      //knht1
    sv_54<< data54;

  const char *path55="/usr/games/Dark_Souls-Demakest/dir_3/sv_55";
    ofstream sv_55(path55);
    string data55(to_string(knht2*95610));                        //knht2
    sv_55<< data55;

 const char *path56="/usr/games/Dark_Souls-Demakest/dir_3/sv_56";
    ofstream sv_56(path56);
    string data56(to_string(pyr*95610));                         //pyr
    sv_56<< data56;

 const char *path57="/usr/games/Dark_Souls-Demakest/dir_3/sv_57";
    ofstream sv_57(path57);
    string data57(to_string(strg*95610));                         //strg
    sv_57<< data57;

  const char *path58="/usr/games/Dark_Souls-Demakest/dir_3/sv_58";
    ofstream sv_58(path58);
    string data58(to_string(firek*95610));                       //firek
    sv_58<< data58;

 const char *path59="/usr/games/Dark_Souls-Demakest/dir_3/sv_59";
    ofstream sv_59(path59);
    string data59(to_string(srp1*95610));                        //srp1
    sv_59<< data59;

 const char *path60="/usr/games/Dark_Souls-Demakest/dir_3/sv_60";
    ofstream sv_60(path60);
    string data60(to_string(strnz*95610));                       //strnz
    sv_60<< data60;

 const char *path61="/usr/games/Dark_Souls-Demakest/dir_3/sv_61";
    ofstream sv_61(path61);
    string data61(to_string(lautrecz*95610));                    //lautrecz
    sv_61<< data61;
//-------------------------------------------save-npc-----------------------------------------------
    }                                                                           //void save() 
...
case'1':
  ...
  cout<<endl<<endl<<"Well, what do we have here? You must be a new arrival. Let me guess. Fate of the Undead, right? Well, you're not the first.But there's no salvation here. You'd have done better to rot in the Undead Asylum… But, too late now.Well, since you're here… Let me help you out. There are actually two Bells of Awakening. One's up above, in the Undead Church. The other is far, far below, in the ruins at the base of Blighttown. Ring them both, and something happens… Brilliant, right? Not much to go on, but I have a feeling that won't stop you. So, off you go. It is why you came, isn't it? To this accursed land of the Undead? Hah hah hah hah…"<<endl<<endl;segue=cin.get();crst=2;
  break;}
  if(crst==2){
  cout<<endl<<endl<<"Oh, your face! You're practically Hollow. But who knows, going Hollow could solve quite a bit! Hah hah hah hah… Hm, what? Restoring your humanity? Well, there are a few ways to go about it… Collect it bit by bit from corpses, or you can butter up a cleric, and get yourself summoned. And the quickest way, although I'd never do it, is to kill a healthy Undead, and pillage its humanity. Coveting thy neighbour is only human, after all! Hah hah hah hah… What are you looking at? Don't try anything clever. You might regret it."<<endl<<endl;segue=cin.get();crst=3;
  break;}
  if(crst==3){
  cout<<endl<<endl<<"Oi, hold on…Don't tell me, have you been cursed? Oh woe is the Undead who's cursed on top of it all Harsh times; harsh times indeed! Hah hah hah hah! No, no, I'm sorry. Here, let me share a nice tip. Long ago, I was told of a remedician who resides in New Londo. Does he really exist? Well, go and find out for yourself. But don't blame me if he's just an apparition! Hah hah hah hah!"<<endl<<endl;segue=cin.get();crst=4;
  break;}
  if(crst==4){
  cout<<endl<<endl<<"Hm? What, you want to hear more? Oh, that's all we need. Another inquisitive soul. Well, listen carefully, then… One of the bells is up above in the Undead Church, but the lift is broken. You'll have to climb the stairs up the ruins, and access the Undead Burg through the waterway. The other bell is back down below the Undead Burg, within the plague-infested Blighttown. But I'd die again before I step foot in that cesspool! Hah hah hah hah…"<<endl<<endl;segue=cin.get();crst=5;
  break;}
  if(crst==5){
  cout<<endl<<endl<<"You again? There's nothing to speak about, really. Oh, actually… Something strange did happen. That crow flew off with somebody in its clutches. I think it was a man curled up in a ball. Stranger things have happened, right? No, maybe not…"<<endl<<endl;segue=cin.get();crst=6;
  break;}
  if(crst==6){
  cout<<endl<<endl<<"Bloody hell, what is it now? You ask too many questions."<<endl<<endl;segue=cin.get();crst=7;
  break;}
  if(crst==7){
  cout<<endl<<endl<<"Have you been to the ruins of New Londo below? Just head down the stairs, and take the lift. It's certainly worth a visit. It was once an Undead city. You may find a clue or two. Unless the ghosts find you first… Keh heh heh heh!"<<endl<<endl;segue=cin.get();crst=8;
  break;}
  if(crst==8){
  cout<<endl<<endl<<"Oh, have you seen that terribly morose lass? … The Fire Keeper. She's stuck keeping that bonfire lit. Sad, really. She's mute and bound to this forsaken place. They probably cut her tongue out back in her village, so that she'd never say any god's name in vain. How do these martyrs keep chugging along? I'd peter out in an instant. Hah hah hah hah…"<<endl<<endl;segue=cin.get();crst=9;
  break;}
  if(crst==9){
  cout<<endl<<endl<<"How did that silly sorcerer's apprentice end up? You know, the one always prattling on about Master Logan. He left for the Undead Burg, but never came back. Serves him right. If even Old Big Hat can't make it out there, what chance does he have? I hope he enjoys his new life as a Hollow."<<endl<<endl;segue=cin.get();crst=69;
  break;}
  if(crst==69){                          //end of spontaneous talking
  cout<<endl<<endl<<"What now? I'm not up for chatting. Leave me alone."<<endl<<endl;segue=cin.get();
  break;}
  if(crst==8){                           //after crossing the first new area
  cout<<endl<<endl<<"What's wrong? Get a bit of scare out there? No problem. Have a seat and get comfortable. We'll both be Hollow before you know it. Hah hah hah hah… Well, what are you going to do? I've already decided. I don't really care; I'm simply crestfallen…"<<endl<<endl;segue=cin.get();crst=69;
  break;}
  if(crst==9){                           //after retrieving griggs
  cout<<endl<<endl<<"How did that nutty sorcerer make it back? Unexpected, but I suppose stranger things have happened."<<endl<<endl;segue=cin.get();crst=69;
  break;}
  if(crst==10){                          //after finding laurentius
  cout<<endl<<endl<<"How did that old man make it back? Unexpected, but I suppose stranger things have happened."<<endl<<endl;segue=cin.get();crst=69;
  break;}
   if(crst==11){                        //after ringing the first bell
  cout<<endl<<endl<<"Why, what a surprise. I didn't expect you to make it. … Oh, somebody rang the bell… Wait. Was it you? You never give up, do you? I don't know how you do it. Well, don't stop now. Only one more, but it's going to be suicide. Hah hah hah hah …"<<endl<<endl;segue=cin.get();crst=69;
  break;}
   if(crst==12){                       //after reah vince and nico comes in
  cout<<endl<<endl<<"Did you see her? That virtuous little maiden, complete with followers in tow. They're probably going straight to pillage graves. I've heard enough about 'M'Lady' for a lifetime."<<endl<<endl;segue=cin.get();crst=69;
  break;}
  if(crst==13){                       //after rescuing reah from the catacombs
  cout<<endl<<endl<<"Did you hear about the maiden? The virtuous lass came back alone, and in absolute tatters… Did her follower die, or was she abandoned? Who knows. But I suppose we've heard the last from 'M'lady'. Hah hah hah hah! That maiden? She's shuffled off somewhere. I believe to the Undead Church. These ruins are probably too awkward for her."<<endl<<endl;segue=cin.get();crst=69;
  break;}
  if(crst==14){                       //after rescuing logan
  cout<<endl<<endl<<"Oi, did you see him? Big Hat Logan, the legendary sorcerer, in the flesh! … This place is simply mad … Legendary heroes popping up left and right … They're making me feel quite inadequate, to be honest! Hah hah hah hah …"<<endl<<endl;segue=cin.get();crst=69;
  break;}
  if(crst==15){                       //after ringing both bells
  cout<<endl<<endl<<"Did you ring the second bell? That is incredible, I must say… But now we have a new problem. It's noisy, it snores, and its breath is lethal… This is no laughing matter, I tell you. Damn, that stench… And I was really beginning to like it here! Sigh… Maybe it's time I do something about it…"<<endl<<endl;segue=cin.get();crst=69;
  break;}
    if(crst==0){cout<<endl<<endl<<"There's no one here."<<endl<<endl;break;}
break;

case'2':
  if(petr==1){
   cout<<endl<<endl<<"Hello there. I believe we are not acquainted? I am Petrus of Thorolund. Have you business with us? ...If not, I'd prefer to keep a distance, if possible."<<endl<<endl;petr=2;segue=cin.get();break;
  }
  if(petr==2){
   cout<<endl<<endl<<"Hello there. I realize that I have requested that we retain our distance, but I also want you to know that it is not meant in ill-will. Here, take this. As a token of peace. No, go ahead. It's for you. (Petrus handed you a Divine Blessing.)"<<endl<<endl;bless=bless+1;petr=3;segue=cin.get();break;
  }
  if(petr==3){
   cout<<endl<<endl<<"Oh, my... you again? Oh, I know. How about this... I have to await my companions here anyway, so, what if I were to teach you some miracles? Would that please you? That is a shame. But each to their own. Speak to me if you have a change of heart."<<endl<<endl;petr=4;segue=cin.get();break;
  }
  if(petr==4){
   cout<<endl<<endl<<"My companions are M'lady and her young knights. She is young, but burdened by an Undead mission. We are her defenses, to keep her from harm."<<endl<<endl;petr=5;segue=cin.get();break;
  }
  if(petr==5){
   cout<<endl<<endl<<"An Undead mission? Regrettably, I cannot share that with you. But you are my pupil, perhaps if you show your faith..."<<endl<<"Hand Petrus of 5000 souls? (y/n)"<<endl<<endl<<"input ";cin>>chose;
     ...
     case'y':
     case'Y':
      if(souls>=5000){souls=souls-5000;cout<<endl<<endl<<"Very well. I can surely tell you, of all people... Undead clerics are given a mission to seek Kindling. Kindling is the art of feeding bonfires with humanity. Through Kindling, we shall one day be granted magnificent powers."<<endl<<endl;petr=6;segue=cin.get();break;}
      else{cout<<endl<<endl<<"(You don't have enaugh souls.) I am afraid that may be difficult. For our missions are sacred."<<endl<<endl;petr=6;segue=cin.get();break;}
     break;
     case'n':
     case'N':
     cout<<endl<<endl<<"I am afraid that may be difficult. For our missions are sacred."<<endl<<endl;petr=6;segue=cin.get();
     break;
     }
     break;
     }
...
break;
case'3':
  if(firek==1){cout<<endl<<endl<<"She can't talk."<<endl<<endl;}
  if(firek==0){cout<<endl<<endl<<"Dead."<<endl<<endl;}
break;
case'4':
  if(mage==1){}
...
case'5':
if(wise==1){}
  if(wise==0){cout<<endl<<endl<<"There's no one here."<<endl<<endl;}
break;
case'6':
if(pray==1){}
  if(pray==0){cout<<endl<<endl<<"There's no one here."<<endl<<endl;}
break;
case'7':
if(knht1==1){}
  if(knht1==0){cout<<endl<<endl<<"There's no one here."<<endl<<endl;}
break;
case'8':
if(knht2==1){}
  if(knht2==0){cout<<endl<<endl<<"There's no one here."<<endl<<endl;}
break;
case'9':
if(pyr==1){}
  if(pyr==0){cout<<endl<<endl<<"There's no one here."<<endl<<endl;}
break;
case'0':
cout<<endl<<endl<<"Who do you want to talk to?"<<endl<<endl;
cout<<"(1) ";if(lautrecz>=1){cout<<"Knight Lautrec of Karim";}cout<<endl;  //Lautrec
cout<<"(2) ";if(strnz>=1){cout<<"Patches the Hyena";}cout<<endl;           //Patches
cout<<"(3) ";if(strg>=1){cout<<"Ingward";}cout<<endl;                      //Ingward
cout<<"(4) ";if(srp1>=1){cout<<"King Seeker Frampt";}cout<<endl;           //Frampt
cout<<"(0) Back"<<endl<<endl<<"input: ";
 cin >> chose;
  switch(chose){
  case'1':
if(lautrecz==1){}
  if(lautrecz==0){cout<<endl<<endl<<"There's no one here."<<endl<<endl;}
  break;
  case'2':
if(strnz==1){}
  if(strnz==0){cout<<endl<<endl<<"There's no one here."<<endl<<endl;}
  break;
  case'3':
if(strg==1){}
  if(strg==0){cout<<endl<<endl<<"There's no one here."<<endl<<endl;}
  break;
  case'4':
if(srp1==1){}
  if(srp1==0){cout<<endl<<endl<<"There's no one here."<<endl<<endl;}
  break;
  case'0':
  break;
  }}}
...
petitelondo= 0;
  ...
  nextlevel= 0;
   ...
   oppsouls= 0;
    ...
    const char *inpath1="/usr/games/Dark_Souls-Demakest/dir_1/sv_1";
    ifstream sv_1 (inpath1);
    if(sv_1.is_open())
    {
    ...
    const char *inpath2="/usr/games/Dark_Souls-Demakest/dir_1/sv_2";
    ifstream sv_2 (inpath2);
    if(sv_2.is_open())
    {
...
const char *inpath3="/usr/games/Dark_Souls-Demakest/dir_1/sv_3";
    ifstream sv_3(inpath3);
    if(sv_3.is_open())
    {
...
const char *inpath4="/usr/games/Dark_Souls-Demakest/dir_1/sv_4";
    ifstream sv_4 (inpath4);
    if(sv_4.is_open())
    {
...
const char *inpath5="/usr/games/Dark_Souls-Demakest/dir_1/sv_5";
    ifstream sv_5 (inpath5);
    if(sv_5.is_open())
    {
...
const char *inpath6="/usr/games/Dark_Souls-Demakest/dir_1/sv_6";
    ifstream sv_6 (inpath6);
    if(sv_6.is_open())
    {
...
const char *inpath7="/usr/games/Dark_Souls-Demakest/dir_2/sv_7";
    ifstream sv_7 (inpath7);
    if(sv_7.is_open())
    {
    ...
    sv_7.close();
                                           ...
                                           //save microarea
   if(world==0){ 
const char *inpath8="/usr/games/Dark_Souls-Demakest/dir_2/sv_8";
    ifstream sv_8 (inpath8);
    if(sv_8.is_open())
    {
...
const char *inpath8="/usr/games/Dark_Souls-Demakest/dir_2/sv_8";
   ...
   const char *inpath9="/usr/games/Dark_Souls-Demakest/dir_1/sv_9";
    ifstream sv_9 (inpath9);
    if(sv_9.is_open())
    {
...
const char *inpath10="/usr/games/Dark_Souls-Demakest/dir_1/sv_10";
    ifstream sv_10 (inpath10);
    if(sv_10.is_open())
    {
...
const char *inpath11="/usr/games/Dark_Souls-Demakest/dir_1/sv_11";
    ifstream sv_11 (inpath11);
    if(sv_11.is_open())
    {
...
const char *inpath12="/usr/games/Dark_Souls-Demakest/dir_1/sv_12";
    ifstream sv_12 (inpath12);
    if(sv_12.is_open())
    {
...
const char *inpath13="/usr/games/Dark_Souls-Demakest/dir_1/sv_13";
    ifstream sv_13 (inpath13);
    if(sv_13.is_open())
    {
...
const char *inpath14="/usr/games/Dark_Souls-Demakest/dir_1/sv_14";
    ifstream sv_14 (inpath14);
    if(sv_14.is_open())
    {
...
const char *inpath15="/usr/games/Dark_Souls-Demakest/dir_1/sv_15";
    ifstream sv_15 (inpath15);
    if(sv_15.is_open())
    {
...
const char *inpath16="/usr/games/Dark_Souls-Demakest/dir_1/sv_16";
    ifstream sv_16 (inpath16);
    if(sv_16.is_open())
    {
...
const char *inpath17="/usr/games/Dark_Souls-Demakest/dir_1/sv_17";
    ifstream sv_17 (inpath17);
    if(sv_17.is_open())
    {
...
const char *inpath18="/usr/games/Dark_Souls-Demakest/dir_3/sv_18";
    ifstream sv_18 (inpath18);
    if(sv_18.is_open())
    {
...
const char *inpath19="/usr/games/Dark_Souls-Demakest/dir_1/sv_19";
    ifstream sv_19 (inpath19);
    if(sv_19.is_open())
    {
...
const char *inpath21="/usr/games/Dark_Souls-Demakest/dir_1/sv_21";
    ifstream sv_21 (inpath21);
    if(sv_21.is_open())
    {
...
//-----------------------------------------------load-one-side-doors-----------------------------------   
const char *inpath22="/usr/games/Dark_Souls-Demakest/dir_4/sv_22";
    ifstream sv_22 (inpath22);
    if(sv_22.is_open())
    {
   ...
   const char *inpath23="/usr/games/Dark_Souls-Demakest/dir_4/sv_23";
    ifstream sv_23 (inpath23);
    if(sv_23.is_open())
    {
   ...
   const char *inpath25="/usr/games/Dark_Souls-Demakest/dir_4/sv_25";
    ifstream sv_25 (inpath25);
    if(sv_25.is_open())
    {
   ...
   const char *inpath26="/usr/games/Dark_Souls-Demakest/dir_4/sv_26";
    ifstream sv_26 (inpath26);
    if(sv_26.is_open())
    {
   ...
   const char *inpath27="/usr/games/Dark_Souls-Demakest/dir_4/sv_27";
    ifstream sv_27 (inpath27);
    if(sv_27.is_open())
    {
   ...
   const char *inpath28="/usr/games/Dark_Souls-Demakest/dir_4/sv_28";
    ifstream sv_28 (inpath28);
    if(sv_28.is_open())
    {
   ...
   const char *inpath29="/usr/games/Dark_Souls-Demakest/dir_4/sv_29";
    ifstream sv_29 (inpath29);
    if(sv_29.is_open())
    {
   ...
   const char *inpath30="/usr/games/Dark_Souls-Demakest/dir_4/sv_30";
    ifstream sv_30 (inpath30);
    if(sv_30.is_open())
    {
...
//-----------------------------------------------load-ground-items-------------------------------------
const char *inpath31="/usr/games/Dark_Souls-Demakest/dir_5/sv_31";
    ifstream sv_31 (inpath31);
    if(sv_31.is_open())
    {
...
const char *inpath32="/usr/games/Dark_Souls-Demakest/dir_5/sv_32";
    ifstream sv_32 (inpath32);
    if(sv_32.is_open())
    {
...
const char *inpath33="/usr/games/Dark_Souls-Demakest/dir_5/sv_33";
    ifstream sv_33 (inpath33);
    if(sv_33.is_open())
    {
...
const char *inpath34="/usr/games/Dark_Souls-Demakest/dir_5/sv_34";
    ifstream sv_34 (inpath34);
    if(sv_34.is_open())
    {
...
const char *inpath36="/usr/games/Dark_Souls-Demakest/dir_5/sv_36";
    ifstream sv_36 (inpath36);
    if(sv_36.is_open())
    {
...
const char *inpath37="/usr/games/Dark_Souls-Demakest/dir_5/sv_37";
    ifstream sv_37 (inpath37);
    if(sv_37.is_open())
    {
...
const char *inpath38="/usr/games/Dark_Souls-Demakest/dir_5/sv_38";
    ifstream sv_38 (inpath38);
    if(sv_38.is_open())
    {
...
const char *inpath39="/usr/games/Dark_Souls-Demakest/dir_5/sv_39";
    ifstream sv_39 (inpath39);
    if(sv_39.is_open())
    {
...
const char *inpath48="/usr/games/Dark_Souls-Demakest/dir_5/sv_48";
   ifstream sv_48 (inpath48);
    if(sv_48.is_open())
    {
...
//-----------------------------------------------load-ground-items-------------------------------------
const char *inpath40="/usr/games/Dark_Souls-Demakest/dir_1/sv_40";
    ifstream sv_40 (inpath40);
    if(sv_40.is_open())
    {
...
const char *inpath41="/usr/games/Dark_Souls-Demakest/dir_6/sv_41";
    ifstream sv_41 (inpath41);
    if(sv_41.is_open())
    {
...
const char *inpath42="/usr/games/Dark_Souls-Demakest/dir_6/sv_42";
    ifstream sv_42 (inpath42);
    if(sv_42.is_open())
    {
...
const char *inpath43="/usr/games/Dark_Souls-Demakest/dir_1/sv_43";
   ifstream sv_43 (inpath43);
    if(sv_43.is_open())
    {
...
const char *inpath44="/usr/games/Dark_Souls-Demakest/dir_1/sv_44";
   ifstream sv_44 (inpath44);
    if(sv_44.is_open())
    {
...
const char *inpath45="/usr/games/Dark_Souls-Demakest/dir_1/sv_45";
   ifstream sv_45 (inpath45);
    if(sv_45.is_open())
    {
...
const char *inpath46="/usr/games/Dark_Souls-Demakest/dir_1/sv_46";
   ifstream sv_46 (inpath46);
    if(sv_46.is_open())
    {
...
const char *inpath47="/usr/games/Dark_Souls-Demakest/dir_1/sv_47";
   ifstream sv_47 (inpath47);
    if(sv_47.is_open())
    {
...
//-----------------------------------load-npcs-------------------------------------------------------
const char *inpath49="/usr/games/Dark_Souls-Demakest/dir_3/sv_49";
   ifstream sv_49 (inpath49);
    if(sv_49.is_open())
    {
...
const char *inpath50="/usr/games/Dark_Souls-Demakest/dir_3/sv_50";
   ifstream sv_50 (inpath50);
    if(sv_50.is_open())
    {
...
const char *inpath51="/usr/games/Dark_Souls-Demakest/dir_3/sv_51";
   ifstream sv_51 (inpath51);
    if(sv_51.is_open())
    {
...
const char *inpath52="/usr/games/Dark_Souls-Demakest/dir_3/sv_52";
   ifstream sv_52 (inpath52);
    if(sv_52.is_open())
    {
...
const char *inpath53="/usr/games/Dark_Souls-Demakest/dir_3/sv_53";
   ifstream sv_53 (inpath53);
    if(sv_53.is_open())
    {
...
const char *inpath54="/usr/games/Dark_Souls-Demakest/dir_3/sv_54";
   ifstream sv_54 (inpath54);
    if(sv_54.is_open())
    {
...
const char *inpath55="/usr/games/Dark_Souls-Demakest/dir_3/sv_55";
   ifstream sv_55 (inpath55);
    if(sv_55.is_open())
    {
...
const char *inpath56="/usr/games/Dark_Souls-Demakest/dir_3/sv_56";
   ifstream sv_56 (inpath56);
    if(sv_56.is_open())
    {
...
const char *inpath57="/usr/games/Dark_Souls-Demakest/dir_3/sv_57";
   ifstream sv_57 (inpath57);
    if(sv_57.is_open())
    {
...
const char *inpath58="/usr/games/Dark_Souls-Demakest/dir_3/sv_58";
   ifstream sv_58 (inpath58);
    if(sv_58.is_open())
    {
...
const char *inpath59="/usr/games/Dark_Souls-Demakest/dir_3/sv_59";
   ifstream sv_59 (inpath59);
    if(sv_59.is_open())
    {
...
const char *inpath60="/usr/games/Dark_Souls-Demakest/dir_3/sv_60";
   ifstream sv_60 (inpath60);
    if(sv_60.is_open())
    {
...
const char *inpath61="/usr/games/Dark_Souls-Demakest/dir_3/sv_60";
    ifstream sv_61 (inpath61);
    if(sv_61.is_open())
    {
...
string segue; //to our omniscent narrator!!
system("clear");
segue=cin.get();
...
system("clear");
cout<<"A land of gray crags,"<<endl<<"Archtrees and Everlasting Dragons.";
segue=cin.get();
...
cout<<"And with fire came disparity.";
segue=cin.get();
system("clear");
...
cout<<"And found the Souls of"<<endl<<"Lords within the flame.";
segue=cin.get();
system("clear");
...
cout<<"the Witch of Izalith"<<endl<<"And her Daughters of Chaos";
segue=cin.get();
system("clear");

cout<<"Gwyn, the Lord of Sunlight"<<endl<<"And his faithful knights";
segue=cin.get();
system("clear");

cout<<"And the furtive pygmy,"<<endl<<"So easily forgotten.";
segue=cin.get();
system("clear");

cout<<"With the Strength of Lords,"<<endl<<"They challenged the Dragons.";
segue=cin.get();
system("clear");

cout<<"Gwyn's mighty"<<endl<<"bolts peeled apart"<<endl<<"their stone scales.";
segue=cin.get();
system("clear");

cout<<"The Witches weaved great firestorms.";
segue=cin.get();
system("clear");

cout<<"Nito unleashed a miasma of death and disease.";
segue=cin.get();
system("clear");

cout<<"And Seath the Scaleless betrayed his own";
segue=cin.get();
system("clear");
...
cout<<"He drops a corpse down in your cage.";
segue=cin.get();
system("clear");
...
<<endl<<"but one must still forge"<<endl<<"Ahead.";
segue=cin.get();
system("clear");

cout<<"You open the cell"
...
save();    
  ...
  cout << "'Undead Asylum'  'Empty space'"<<endl<<"Souls: "<<souls<<endl<<hp<<"HP    "<<stm<<"STM"
   <<endl<<endl<<"Select where to go:"<<endl<<
   "(W) To the huge door"<<endl<<"(A) Check left corner"<<endl<<"(S) Down the ladder"<<endl<<"(D) Check right corner"<<endl<<"(Q) Rest at the Bonfire"<<endl<<"(E) Inventory"
  <<endl<<endl<<"input: ";
  cin >> chose;
     switch(chose) {
     case 's':
...
save();
  ...
  cin >> chose;
     ...
     if(oscar==1){
     cout<<endl<<endl<<
     "You found the knight that dropped you the key to your cell!";segue=cin.get();cout<<endl<<endl<<"(press Enter to continue)";
     cout<<endl<<
     "(?)...Oh, you... You're no Hollow, eh? Thank goodness...";segue=cin.get();
     cout<<endl<<
     "I'm done for, I'm afraid... I'll die soon, then lose my sanity...";segue=cin.get();
     cout<<endl<<
     "I wish to ask something of you... You and I, we're both Undead... Hear me out, will you?";segue=cin.get();
     cout<<endl<<
     "...Regrettably, I have failed in my mission... But perhaps you can keep the torch lit... ";segue=cin.get();
     cout<<endl<<
     "There is an old saying in my family... Thou who art Undead, art chosen...";segue=cin.get();
     cout<<endl<<
     "In thine exodus from the Undead Asylum, maketh pilgrimage to the land of Ancient Lords...";segue=cin.get();
     cout<<endl<<
     "When thou ringeth the Bell of Awakening, the fate of the Undead thou shalt know...";segue=cin.get();
     cout<<endl<<
     "Well, now you know... And I can die with hope in my heart...";segue=cin.get();
     cout<<endl<<
     "Oh, one more thing... Here, take this... An Estus Flask, an Undead favourite...";segue=cin.get();
     cout<<endl<<
     "Oh, and this...";segue=cin.get(); 
     cout<<endl<<"'The knight gave you another key'";segue=cin.get();
     cout<<endl<<endl<<
     "...Now I must bid farewell... I would hate to harm you after death... So, go now... And thank you...";segue=cin.get();
     cout<<endl<<endl<<endl;
...
cout << "'Undead Asylum'  'Snowy Precipice'"<<endl<<"Souls: "<<souls<<endl<<hp<<"HP    "<<stm<<"STM"
  ...
  cin >> chose;
     ...
     case 'W':
     if(gotolord==0){
     cout<<endl<<"Only, in the ancient legends it is stated,";segue=cin.get();cout<<endl<<endl<<"(press Enter to continue)";
     cout<<endl<<"that one day an undead shall be chosen to leave the undead asylum, in pilgrimage,";segue=cin.get();
     cout<<endl<<"to the land of ancient lords,";segue=cin.get();
     cout<<endl<<endl<<"Lordran.";segue=cin.get();
     }
     cout<<endl<<endl<<"A gigant crow appreared from down the peak!";segue=cin.get();
     if(snuggly>0){cout<<endl<<"Looks like the mother of the little crow from before.";segue=cin.get();}
     cout<<endl<<"It grabs you in its mouth and take you on a fly with them.";segue=cin.get();
     cout<<endl<<"Several hours later it finally lands and drops you right in front of a Bonfire.";segue=cin.get();
     cout<<endl<<endl;
     world=1;undasyl=0;firelink=1;gotolord=1;
     break;
     case'a':
     case'A':
     if(item6==1){
     ...
     else{cout<<endl<<endl<<"You checked this ledge already."<<endl<<endl;humanity=99;}//demo only?
     break;
     case's':
     case'S':
     undasyl=5;
...
save();gotolord=1;
  ...
  cin >> chose;
     ...
     case'x':
     case'X':
     world=0;firelink=0;undasyl=12;//demo only
     break;
     case 'w':
     case 'W':
     cout<<endl<<endl<<"Next world areas in the future versions of the software."<<endl<<"Thank you for playing the demo!"<<endl<<"You can have fun with the last interactions of the game."<<endl<<endl;
     break;
     case 'a':
     case 'A':
     cout<<endl<<endl<<"Next world areas in the future versions of the software."<<endl<<"Thank you for playing the demo!"<<endl<<"You can have fun with the last interactions of the game."<<endl<<endl;
