...
case'1':
  ...
  break;}
  break;
    if(crst==0){cout<<endl<<endl<<"There's no one here."<<endl<<endl;segue=cin.get();}
break;
case'2':
  if(petr==1){
  ...
  if(petr==6){
   cout<<endl<<endl<<"Oh, hello. Miracles, I presume? Yes, I know."<<endl<<endl;shopper=1;shop();save();segue=cin.get();break;
break;
case'3':
break;
case'4':
...
save();
  ...
  cin >> chose;
     ...
     if(oscar==1){
     cout<<endl<<endl<<
     "You found the knight that dropped you the key to your cell!";segue=cin.get();
     cout<<endl<<
...
cout << "'Undead Asylum'  'Snowy Precipice'"<<endl<<"Souls: "<<souls<<endl<<hp<<"HP    "<<stm<<"STM"
  ...
  cin >> chose;
     ...
     case 'W':
     if(gotolord==0){
     cout<<endl<<"Only, in the ancient legends it is stated,";segue=cin.get();
